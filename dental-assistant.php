...
<title>Dental Assistant Programs | Vatterott College</title>
...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner dental">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott College - Dental Assistant Degree Program</h2>
   <h4>Degree Earned: </h4>
        <ul>
<li>Dental Assistant Technology – Diploma/Certificate</li>     	
        
        <h4>Dental Assistant Schools:</h4>
    <ul>
