...
<title>Pharmacy Technician | Vatterott College</title>
...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner pharm">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
       <h2 class="tag1">Vatterott College - Pharmacy Technician Programs</h2>
   <h4>Degree Earned: </h4>
        <ul>

<li>Pharmacy Technician – Diploma/Certificate</li></ul>
        
        <h4>Pharmacy Technician Schools:</h4>
    <ul>
		<li> <a href="vatterott-college-northpark-berkely.php">Vatterott College - Northpark-Berkeley, MO</a></li>

    </ul>
<h2>Pharmacy Technician Classes at Vatterott College are Enrolling Now!</h2>
<p>Students receive instruction from experts in each Pharmacy Technician course at Vatterott. The Pharmacy Technician Associates of Occupational Studies introduces students to fundamental medical language and office basics, as well as medical ethics and billing. Pharmacy Assistant classes progress toward more advanced concepts such as medical dosages, pharmaceutical calculations, a comprehensive pharmacy technician externship, and more.</p>
<p>"Employment of pharmacy technicians is projected to grow 20 percent from 2012 to 2022, faster than the average for all occupations. Several factors will lead to increased demand for prescription medications." - <strong>Bureau of Labor Statistics</strong></p>
                </p>
        <div style="clear:both"></div>
