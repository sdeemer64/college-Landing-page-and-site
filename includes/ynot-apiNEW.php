...
(function($) {
         ...
         $.getJSON("https://api.ynotlms.com/locations.json?uid=864&apikey=97059e00e5-swvv9ztzp8-5vb9phoulv&jsoncallback=?",
/*
...
*/
      ...
      /* prog is the list of IDs to exclude from view 
      progIn is the array of ID to Use
      as we have the list To use and not th elist Not to use on this page we will use the array 
      progIn
      */
          var prog=[83,46];
          var progIn=[100,110,12,13,140,145,146,17,18,226,398,46,47,48,49,50,516,55,6,60,600,61,62,620,63,64,65,67,8];
          ...
          $.each(data, function(i,item){
           ...
           if ($.inArray(program.id , progIn)!== -1){  
