...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner appling">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott Career College - Appling Farms</h2>
  

<h2>Trade School Classes & Career College Programs in Memphis Enrolling Now!</h2>
<p>The facility at 6991 Appling Farms Parkway, Memphis, TN occupies 25,000 square feet and contains furnished classrooms, laboratories, faculty and administrative offices, a library containing reference and reading materials related to the academic programs, and a student lounge.</p>
    ...
    <ul>
		<li><a href="automotive-technology.php">Powersports Equipment and Small Engine Mechanic</a></li>
		<li><a href="diesel-mechanic.php">Diesel Mechanic</a></li>
				
    </ul>

<p>At the Memphis, TN Appling Farms campus, you can expect:</p>
<ul>
