...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner sunset">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott College - Sunset Hills, MO (South County)</h2>
  

<h2>Trade School Classes & Career College Programs in St. Louis - Sunset Hills Enrolling Now!</h2>
<p>The facilities on Maurer Industrial Drive are located in a convenient suburban setting adjacent to major thoroughfares and accessible from all parts of the metro area. The three educational buildings contain approximately 87,000 square feet designed to provide our students with the best environment to reach to their learning potential.</p>
    ...
    <ul>
		<li><a href="automotive-technology.php">Auto Body and Alternative Fuel Vehicle Repair Technician</a></li>
		<li><a href="building-maintenance.php">Building Maintenance</a></li>
