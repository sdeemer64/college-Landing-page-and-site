...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner oklahoma">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott Career College - Oklahoma City</h2>
  

<h2>Trade School Classes & Programs in Oklahoma City Enrolling Now!</h2>
<!--
The facility located at 2655 Dividend Drive, Memphis, TN has a total of 35,000 square feet of space dedicated to lecture, shop, and lab areas containing industry related equipment and computers needed for demonstration and instruction.</p>
-->   


<p>
	
Our training goal is to provide the basic skills and understanding of common techniques and procedures required for employability. Higher-level technical skills are also offered to qualified students. The skills and work attitudes taught at Vatterott College are of practical use to the student in his/her chosen career and ensure successful adjustment to the work environment.
</p>
    ...
    <ul>
	      ...
	      <li><a href="windenergy.php">Wind Energy Technician</a></li>
			  <li><a href="hvac.php">HVAC</a></li>
    </ul>

<p>

At the Oklahoma City, OK campus, you can expect:
<ul>
    <li>Industry-Current Equipment</li>
...
<!--   
    ...
    <ul> 
		...
		<li><a href="medical-assistant.php">Medical Assistant w/ Office Management</a></li>
		 ...
		 <h3>Trade Programs:</h3>
    <ul>
    <li><a href="auto-body-and-alternative-fuel-vehicle-repair.php">Auto Body and Alternative Fuel Vehicle Repair Technician</a></li>
		<li><a href="automotive-technology.php">Automotive Technology</a></li>
...
<p>At the Memphis, TN Dividend campus, you can expect:</p>
<ul>
<li>Industry-Current Equipment</li>
<li>Financial Aid for Those who Qualify</li>
<li>Student Support Services</li>
...
<p>Vatterott Career College is authorized for operation as a postsecondary educational institution by the Tennessee Higher Education Commission. In order to view detailed job placement and graduation information on the programs offered by Vatterott, please visit www.state.tn.us/thec and click on the Authorized Institutions Data button. </p>
