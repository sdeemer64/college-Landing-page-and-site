...
<title>Veterinary Technician Programs | Vatterott College</title>
...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner vet">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott College - Veterinary Technician Degree Program</h2>
   <h4>Degree Earned: </h4>
        <ul>
<li>Veterinary Technician Technology – Associate of Applied Science</li>     	
        
        <h4>Veterinary Technician Schools:</h4>
    <ul>
    <li> <a href="vatterott-college-fairview-heights.php">Vatterott College - Fairview Heights, IL</a></li>


    </ul>
    <h2>Veterinary Technician Training Classes in Fairview Heights are Enrolling Now!</h2>
    <p>Students receive instruction from industry experienced experts in each Fairview Heights Veterinary Technician course. </p>
    <p>The Veterinary Technician Associates in Applied Science provides courses in animal nursing, clinical pathology, pharmacology, lab animal procedures, animal diseases, office management and fundamental science, math and communication. Classes cover veterinary law and ethics, medical terminology, ultrasound and diagnostic imaging, vaccination protocols, clinical tasks, nutrition and much more. Students complete a career skills course and externship prior to graduation. </p>
		<p>Graduates of this program should possess the skills to pursue residential and commercial employment. </p>
