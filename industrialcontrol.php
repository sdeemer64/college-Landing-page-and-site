...
<title>Industrial Control Programs | Vatterott College</title>
...
<div id="wrapper" class="innerpage"> 
  ...
  <div class="banner_wrapper banner_wrapperinner indust">
  ...
  <div class="body_wrapper">
    <div class="body_inner">
      <div class="content_left_inner">
        <h2 class="tag1">Vatterott College - Industrial Control Technology Program</h2>
<!--
   <h4>Degree Earned: </h4>
        <ul>
<li>– Diploma/Certificate</li>
        ...
        -->
        <h4>Industrial Control Technology Schools:</h4>
    <ul>
...
<ul>
    ...
    <li>Allen-Bradley Programmable Logic Controllers</li>
    <li>GE/Fanuc Programmable Logic Controllers</li>
    <li>Introduction to Pneumatics</li>
